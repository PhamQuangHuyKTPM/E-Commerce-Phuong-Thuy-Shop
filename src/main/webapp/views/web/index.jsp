...
<link href= "./template/web/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
...
<body>
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="./template/web/img/banner1.png" alt="Image">
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="./template/web/img/banner2.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
        <c:forEach var="categories" items="${categories }" begin="0" end="5">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="${categories.image }" alt="" style="width : 100%; height: 250px">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">${categories.ten }</h5>
                </div>
            </div>
           </c:forEach>
        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="${products.image }" alt="" style="width : 100%; height : 260px">
                    </div>
