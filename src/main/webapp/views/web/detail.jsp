	...
	<div class="container-fluid py-5">
		<div class="row px-xl-5">
				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner border">
						<div class="carousel-item active">
							<img class="" src="${product.image }" alt="Image" style="width : 550px; height: 550px">
						</div>
					</div>
			...
			<div class="col-lg-7 pb-5">
				<h3 class="font-weight-semi-bold">${product.ten }</h3>
				...
				<h3 class="font-weight-semi-bold mb-4">${product.dongia }</h3>
				...
				<div class="d-flex align-items-center mb-4 pt-2">
					...
					<c:if test="${manager != null }">
						<a href="chi-tiet-san-pham?status=add-to-cart&id=${product.id }"
					...
					<c:if test="${manager == null }">
					<a href="login" class="btn btn-primary px-3">
